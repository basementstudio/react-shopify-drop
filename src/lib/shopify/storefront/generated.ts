...
export type CartCreatePayloadFragment = {
  __typename?: 'CartCreatePayload'
  cart?:
    | {
        __typename?: 'Cart'
...
export type ProductFragment = {
  ...
  handle: string
  productType: string
  onlineStoreUrl?: any | null | undefined
...
export type GetProductsOnCollectionQuery = {
  __typename?: 'QueryRoot'
  collection?:
    | {
        __typename?: 'Collection'
...
export function getSdk(
  ...
  return {
    ...
    CreateCartWithLines(
      variables: CreateCartWithLinesMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<CreateCartWithLinesMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<CreateCartWithLinesMutation>(
            CreateCartWithLinesDocument,
            variables,
    ...
    AddLineItem(
      variables: AddLineItemMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<AddLineItemMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<AddLineItemMutation>(AddLineItemDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders
          }),
        'AddLineItem'
    ...
    UpdateLineItem(
      variables: UpdateLineItemMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<UpdateLineItemMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<UpdateLineItemMutation>(
    ...
    RemoveLineItem(
      variables: RemoveLineItemMutationVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<RemoveLineItemMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<RemoveLineItemMutation>(
    ...
    FetchCart(
      variables: FetchCartQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<FetchCartQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<FetchCartQuery>(FetchCartDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders
          }),
        'FetchCart'
    ...
    GetProductsOnCollection(
      variables: GetProductsOnCollectionQueryVariables,
      requestHeaders?: Dom.RequestInit['headers']
    ): Promise<GetProductsOnCollectionQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetProductsOnCollectionQuery>(
            GetProductsOnCollectionDocument,
            variables,
            { ...requestHeaders, ...wrappedRequestHeaders }
          ),
        'GetProductsOnCollection'
    ...
    GetCollections(
      ...
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetCollectionsQuery>(
